...
public class GameServer implements IGameServer {
	 ...
	 * @param player - gracz
	 * @param opponent - przeciwnik
	 * @param randomRole - czy ma by� losowana rola zgaduj�cy/wprowadzaj�cy s�owo
	 * @return Game - gra
	 * @exception  
	 */
...
//		}
	...
	/**
	 * Dodaje gracza i wysy�a komunikat od�wie�enia listy
	 * @author Norbert Matrzak
	 * @param player - gracz
	 * @param 
	 * @param 
	...
	/**
	 * Usuwa gracza i wysy�a komunikat od�wie�enia listy
	 * @author Norbert Matrzak
	 * @param player - gracz
	 * @param 
	 * @param 
	...
	/**
	 * Wyszukuje gr� dla danej pary graczy,
	 * @author Norbert Matrzak
	...
	/**
	 * Ko�czy gr� - ustawia status grze i u�ytkownikom, ewentualnie usuwa gr� z listy gier, od�wie�a list� gier
	 * @author Norbert Matrzak
	 * @param playerName - nazwa gracza
	 * @return znaleziony obiekt klasy Game lub null, gdy gra usuni�ta
	 * @exception  
	 */
...
//	}
	...
	/**
	 * Od�wie�a list� gier, i wysy�a sygna� do klienta (przegl�darki) - ��danie od�wie�enia listy graczy
	 * @author Norbert Matrzak
	 * @param 
	 * @return 
	 * @exception  
	...
	/**
	 * Zwraca list� graczy, na potrzeby javascript, zawsze dodawani s� dwaj gracze niewidoczni, tak aby JavaScrit zawsza widzia� obiekt jako list� obiekt�w gracz
	 * @author Norbert Matrzak
	 * @param 
	 * @return lista graczy
	 * @exception  
...
//		System.out.print("GameServer.createInvisiblePlayer: " + playerName);
	...
	/**
	 * Aktualizuje wybrakowane - szukane s�owo o podan� / wys�an� liter�
	 * @author Norbert Matrzak
	 * @param player - gracz
	...
	/**
	 * Aktualizuje  słowo do zgadnięcie
	 * @author Norbert Matrzak
	 * @param player - gracz
	 * @param letter - wysłana litera (może być zakodowana w przypadku polskich diaktrycznych liter)
	 * @return gra - przypisana do gracza
	 * @exception  
	 */		
	...
	/**
	 * Ko�czy gr� dla danego gracza i wykonuje dodatkowe czynno�ci - komunikat o zako�czeniu gry
	 * @author Norbert Matrzak
	 * @param player - gracz
	 * @param 
	 * @return 
	...
	/**
	 * Ko�czy gr� i wykonuje dodatkowe czynno�ci - wykonanie czynno�ci oraz wys�anie komunikat�w
	 * @author Norbert Matrzak
	 * @param player - gracz
	 * @param 
	 * @return 
